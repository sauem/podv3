!function (e, t) {
    ...
    var t = "SweetAlert2:", f = function (e) {
        ...
        X = function (e) {
            ...
            if (!e) return F(t);
            if (e instanceof HTMLElement) t.appendChild(e); else if ("object" === q(e)) if (t.innerHTML = "", 0 in e) for (var n = 0; n in e; n++) t.appendChild(e[n].cloneNode(!0)); else t.appendChild(e.cloneNode(!0)); else e && (t.innerHTML = e);
            K(t)
        }, ee = function () {
            if (j()) return !1;
    ...
    var Ve, qe = Object.freeze({
        hideLoading: Ee, disableLoading: Ee, getInput: function (e) {
        ...
        }, showValidationMessage: Le, resetValidationMessage: Oe, resetValidationError: function () {
            ...
            return new Promise(function (t, n) {
                ...
                switch (M.input) {
                    ...
                    case"radio":
                        ...
                        break;
                    case"checkbox":
                        var P = U(j.content, _.checkbox), E = T.getInput("checkbox");
