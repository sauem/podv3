...
class ContactsLog extends BaseModel
{
    ...
    public function rules()
    {
        return [
            ...
            [['user_id', 'contact_id', 'created_at', 'updated_at','callback_time'], 'integer'],
    ...
    public function afterSave($insert, $changedAttributes)
    {
        if($insert){
            ...
            if($this->callback_time){
                ContactsAssignment::updateAll(['callback_time' => $this->callback_time,'status' => ContactsAssignment::_PENDING],['user_id' => $this->user_id,'contact_phone' => $this->phone]);
            }
        }
