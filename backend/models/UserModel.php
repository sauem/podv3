...
class UserModel extends User
{
    ...
    public function afterSave($insert, $changedAttributes)
    {
        ...
        if($insert){
            ActionLog::add("success", "Tạo tài khoản mới $this->username");
        }
        ActionLog::add("success", "Cập nhật tài khoản $this->username");
    ...
    {
        ActionLog::add("success", "Xóa tài khoản $this->username");
