        ...
        <div class="col-md-7">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Danh sách mẫu</h4>
                </div>
                <div class="card-body">
                    <?= GridView::widget([
            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between">
                    <h4 class="card-title">Mẫu cần cập nhật</h4>
        ...
        <div class="col-md-5">
            <div class="card">
                <div class="card-header justify-content-between d-flex">
                    <h4 class="card-title">Tạo mẫu</h4>
                    <div class="card-tools">
                        ...
                        <div class="col-12">
                            <div class=" mt-4 text-right">
                                <?php if ($model->isNewRecord && !$model->content) { ?>
                                    <?= Html::resetButton("<i class='fe-refresh-ccw'></i> Làm mơi", ['class' => 'btn btn-sm btn-warning']) ?>
                                <?php } else { ?>
                                    <?= Component::reset('Hủy') ?>
                                <?php } ?>
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer d-flex justify-content-between">
                    ...
                    <div>
                        ...
                        <button  data-action="order" class="btn btn-sm handleData btn-primary">Nhập sản phẩm
                        </button>
                    </div>
                </div>
            </div>
